...
const Blogs = () => {
  return (
    <section id="blogs" className="py-16 px-4 md:px-20 bg-gradient-to-b from-gray-800 to-gray-900 text-white">
      <h2 className="text-4xl font-bold mb-10 underline">BLOGS</h2>
      ...
      {blogs.length > 3 && (
        <div className="text-center mt-12">
          <a href="/blogs-archive" className="text-teal-400 text-lg font-semibold flex items-center justify-center">
            View Writing Archive <FontAwesomeIcon icon={faArrowRight} className="ml-2" />
          </a>
        </div>
      )}
    </section>
